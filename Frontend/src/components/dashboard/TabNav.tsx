...
import { DASHBOARD_NAV } from "@/types/dashboard";

/* SVG icon map — compact inline icons for each nav item */
function NavIcon({ name, size = 18 }: { name: string; size?: number }) {
  ...
  switch (name) {
    ...
    case "integrations":
      return (
        <svg {...props}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 7.5 16.5 5.25m0 0 2.25 2.25M16.5 5.25V11.25m-6.75 5.25L7.5 18.75m0 0-2.25-2.25M7.5 18.75V12.75M3.75 9h5.25M15 15h5.25" />
        </svg>
      );
    default:
      return (
